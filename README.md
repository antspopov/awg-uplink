...
- **Файрвол панели** — переключатель «включить» (по умолчанию включён): если **UFW** установлен и **active**, правила панели только с меткой **`awg-web-ui-fw`** (остальные правила UFW не трогаем). Если **ufw нет** или UFW **не включён** — **fallback на nftables** (таблица `inet awg_webui_fw`). **Georouting и DNS-transport-lock** по-прежнему на nftables.
